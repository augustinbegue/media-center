...
IMMICH_URL=https://immich.server.begue.cc
IMMICH_API_KEY=<from OpenBao>
IMMICH_FALLBACK_ALBUM_ID=<album uuid>
IMMICH_FEATURED_SOURCE=explore
IMMICH_FETCH_SIZE=8
IMMICH_ALLOW_RANDOM_FALLBACK=false
PRIM_API_KEY=<from PRIM portal>
PRIM_BASE_URL=https://prim.iledefrance-mobilites.fr/marketplace
PRIM_NEXT_DEPARTURES_URL=https://prim.iledefrance-mobilites.fr/marketplace/stop-monitoring
PRIM_MESSAGES_URL=https://prim.iledefrance-mobilites.fr/marketplace/general-message
PRIM_MONITORING_REF=<StopPoint/StopArea monitoring ref>
PRIM_LINE_REF=<optional line ref>
PRIM_DESTINATION_REF=<optional destination ref>
PRIM_LIMIT=4
PRIM_STOP_LABEL=Paris Transit
